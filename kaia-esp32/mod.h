#ifndef MICRO_ROS_ARDUINO_MOD
#define MICRO_ROS_ARDUINO_MOD
...
static inline void set_microros_wifi_transports_mod(char * ssid, char * pass, char * agent_ip, uint agent_port){
